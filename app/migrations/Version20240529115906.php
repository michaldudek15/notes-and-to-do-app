 ...
 */
final class Version20240529115906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tags CHANGE title title VARCHAR(64) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tags CHANGE title title VARCHAR(255) NOT NULL');
    }
}
